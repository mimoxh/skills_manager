...
$Readme = @(
  ...
  "2. Keep the program in a writable folder. Skills are stored beside the exe in skills/.",
  "3. The app copies skills from the previous hub on first use and keeps the old files.",
  "",
  "Notes:",
